//DIGITAL PHONE-BOOK App using C programing language 
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
#include<time.h>
...
void Password()
{
    ...
    while(1)
    {
     //   system("cls");
        ...
        printf("\t\t\t\t\t\t\t\t\t\t\tForgot The Password : (-1)\n");
        printf("\t\t\t\t\t\t\t\t\t\t\tReset The Password  : (-2)\n\n");
        printf("\t\t\Password : ");
        scanf("%d",&p);
        ...
        else if(p == -1)
        {
            while(1)
            {
                printf("\t\4 What is your Birth Date ? [Input : Day [enter] Month [enter] Year [enter]    ->");
                scanf("%d%d%d",&d,&m,&y);
                if(d == 1 && m == 4 && y == 1998)
                {
                    printf("\t\4 How many siblings do you have ?    ->");
                    scanf("%d",&s);
                    if(s == 2)
                    {
                        printf("\t\4 Are you married ? [1=yes | 0=no]    ->");
                        scanf("%d",&s);
                        if(w == 0)
                        {
